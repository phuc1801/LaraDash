...
<head>
    ...
    <script type="module" crossorigin src="bootstrap/calendar-Bv9AekZw.js"></script>
                ...
                <div class="sidebar-content">
                    <nav class="sidebar-nav">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('calendar') }}">
                ...
                <div class="container-fluid p-4 p-lg-4">
                    ...
                    <div x-data="calendarComponent" x-init="init()">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div>
                                <h1 class="h3 mb-0">Sự kiện</h1>
                                <p class="text-muted mb-0">Lên lịch và quản lý sự kiện</p>
                            </div>
