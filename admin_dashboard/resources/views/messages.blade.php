...
<head>
  ...
  <script type="module" crossorigin src="bootstrap/messages-CRvs10Nl.js"></script>
            ...
            <main class="admin-main">
                <div class="container-fluid p-4 p-lg-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            <h1 class="h3 mb-0">Phản hồi người dùng</h1>
                            <p class="text-muted mb-0">Trung tâm truyền thông thời gian thực</p>
                        </div>
