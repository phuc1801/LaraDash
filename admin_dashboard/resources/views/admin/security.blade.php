...
<head>
    ...
    <script type="module" crossorigin src="bootstrap/security-Cu4PFUIp.js"></script>
            ...
            <main class="admin-main">
                <div class="container-fluid p-4 p-lg-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h1 class="h3 mb-0">Bảo mật & Xác thực</h1>
                            <p class="text-muted mb-0">Quản lý bảo mật tài khoản và kiểm soát quyền truy cập</p>
                        </div>
