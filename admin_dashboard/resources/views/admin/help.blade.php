                ...
                <div class="sidebar-content">
                    <nav class="sidebar-nav">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('help') }}">
                ...
                <div class="container-fluid p-4 p-lg-5">
                    ...
                    <div x-data="helpComponent" x-init="init()" class="help-layout">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4 mb-lg-5 mb-xl-6">
                            <div>
                                <h1 class="h3 mb-0">Trợ giúp & Hỗ trợ</h1>
                                <p class="text-muted mb-0">Nhận trợ giúp, tìm tài liệu và liên hệ bộ phận hỗ trợ</p>
                            </div>
