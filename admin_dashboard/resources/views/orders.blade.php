                ...
                <div class="container-fluid p-4 p-lg-5">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 mb-lg-5">
                        <div>
                            ...
                            <p class="text-muted mb-0">Theo dõi đơn hàng, quản lý việc thực hiện và phân tích doanh số</p>
                        </div>
                                ...
                                <div class="card stats-card">
                                    <div class="card-body p-3 p-lg-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div x-data="{ stats: { total: 0 } }" x-init="
                                                fetch('http://localhost:8000/api/orders/count')
                                                .then(res => res.json())
                                                .then(data => { if(data.status) stats.total = data.total_orders });
                                                ">
                                                <h6 class="mb-0 text-muted">Tổng số đơn hàng</h6>
