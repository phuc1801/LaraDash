...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/svg+xml" href="{{ asset('bootstrap/favicon-CvUZKS4z.svg') }}">
    <link rel="icon" type="image/png" href="{{ asset('bootstrap/favicon-B_cwPWBd.png') }}">
    ...
    <!-- PWA Manifest -->
    <link rel="manifest" href="{{ asset('bootstrap/manifest-DTaoG9pG.json') }}">

    <!-- CSS -->
    <link rel="stylesheet" href="{{ asset('bootstrap/main-D9K-blpF.css') }}">

    <!-- JS -->
    <script type="module" crossorigin src="{{ asset('bootstrap/main-BPhDq89w.js') }}"></script>
                    ...
                    <div class="navbar-nav flex-row">
                        ...
                        <div class="dropdown me-2">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item" href="#">Người dùng mới đã đăng ký</a></li>
            ...
            <div class="container-fluid p-4 p-lg-5">
                        ...
                        <div class="card stats-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-0 text-muted">Phản hồi trung bình</h6>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="card-title mb-0">Tổng quan về doanh thu</h5>
                                ...
                                <div class="activity-feed">
                                    <div class="activity-item">
                                        ...
                                        <div class="activity-content">
                                            <p class="mb-1">Người dùng mới đã đăng ký</p>
                                    ...
                                    <div class="activity-item">
                                        ...
                                        <div class="activity-content">
                                            <p class="mb-1">Đơn hàng #1234 đã hoàn thành</p>
                                    ...
                                    <div class="activity-item">
                                        ...
                                        <div class="activity-content">
                                            <p class="mb-1">Đã lên lịch bảo trì máy chủ</p>
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Đơn đặt hàng gần đây</h5>
                            </div>
                            <div class="card-body">
