                ...
                <div class="container-fluid p-4 p-lg-5">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 mb-lg-5">
                        <div>
                            ...
                            <p class="text-muted mb-0">Thông tin chi tiết toàn diện và số liệu hiệu suất</p>
                        </div>
                    ...
                    <div x-data="analyticsComponent" x-init="init()">
                            ...
                            <div class="col-lg-4">
                                <div class="card h-100">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Nguồn lưu lượng truy cập</h5>
                                    </div>
                                    <div class="card-body p-3 p-lg-4">
                        ...
                        <div class="row g-4 g-lg-5 g-xl-6 mb-5 mb-lg-5 mb-xl-6">
                            ...
                            <div class="col-lg-6">
                                <div class="card h-100">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Luồng hành vi người dùng</h5>
                                    </div>
                                    <div class="card-body p-3 p-lg-4">
                            ...
                            <div class="col-lg-6">
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            <h5 class="card-title mb-0 me-2">Hoạt động thời gian thực</h5>
                        ...
                        <div class="row g-4 g-lg-5 g-xl-6">
                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Các trang hoạt động hàng đầu</h5>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card h-100">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Phân bố địa lý</h5>
                                    </div>
                                    <div class="card-body p-3 p-lg-4">
